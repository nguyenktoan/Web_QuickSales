    ...
    <div className="font-[sans-serif] text-[#333]">
      <div className="flex items-center justify-center min-h-screen px-4 py-6 fle-col">
        <div className="grid items-center w-full max-w-6xl gap-10 md:grid-cols-2">
          ...
          <form className="w-full max-w-md space-y-6 md:ml-auto max-md:mx-auto">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                />
                <label className="block ml-3 text-sm">Remember me</label>
              </div>
            ...
            <p className="my-10 text-sm text-center text-gray-400">
              or continue with
            </p>
