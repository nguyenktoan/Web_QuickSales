      ...
      <div className="w-full max-w-sm p-4 bg-white rounded-lg shadow dark:bg-gray-800 md:p-6">
        <div className="flex justify-between mb-5">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <h5 className="inline-flex items-center mb-2 font-normal leading-none text-gray-500 dark:text-gray-400">
                Clicks
                <svg
                  data-popover-target="clicks-info"
                  data-popover-placement="bottom"
                  className="w-3 h-3 text-gray-400 cursor-pointer hover:text-gray-900 dark:hover:text-white ms-1"
                  aria-hidden="true"
