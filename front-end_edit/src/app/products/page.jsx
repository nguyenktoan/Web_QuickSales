...
const ProductsPage = () => {
  ...
  return (
    <div>
      <div className="w-full h-full mt-10 text-3xl font-semibold font-bold text-center text-gray-700 bg-gradient-to-tr f shrink-0">
        <span> Products</span>
      </div>
      <section
        ...
        {products.map((value, index) => {
          ...
          return (
            <ProductComponent
              ...
              in_stock={value.attributes.in_stock}
            />
          );
        })}
      </section>
