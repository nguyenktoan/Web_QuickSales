...
const ProfilePage = () => {
  ...
  return (
    <div className="flex w-full min-h-screen">
      {/* Avatar */}
      <div className="border-solid border-black border-r-2 w-1/3 min-h-screen items-center content-center		">
      ...
      {/* Còn lại */}
      <div className="w-2/3">
        <div className="ml-5 flex flex-col border-b-2  h-fit p-px w-screen ">
          <span className="font-bold text-3xl">My Profile</span>
          <span className="mb-5">Manage and protect your account</span>
        </div>
        {/* info */}
        <div>
          <form className="space-y-6 max-w-sm mx-10 mt-10 font-[sans-serif]">
            <div className="flex items-center">
              <label className="text-gray-400 w-36 text-sm">Name</label>
              <input
                type="text"
                placeholder={user.name}
                className="px-2 py-2 text-black w-full border-b-2 focus:border-[#333] outline-none text-sm bg-white placeholder-gray-500" // Thêm placeholder-gray-500 vào đây
              />
            </div>
            <div className="flex items-center">
