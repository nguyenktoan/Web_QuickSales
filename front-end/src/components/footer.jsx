...
const Footer = () => {
  return (
    <footer className="mt-3 bg-gray-900 p-10 font-[sans-serif] mb-0">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        <div className="lg:flex lg:items-center">
          <a href="javascript:void(0)">
            <img src="/logoF.png" alt="logo" className="w-52" />
          </a>
        </div>
          ...
          <ul className="space-y-4">
            ...
            <li>
              <a
                ...
                className="text-gray-300 hover:text-white text-sm"
              >
                Address: Gr09 Number 1, A+ Distric, Web City
              </a>
            </li>
          </ul>
        </div>
      ...
      <p className="text-gray-300 text-sm mt-10">© 202ô All Rights Reserved.</p>
    </footer>
  );
};
